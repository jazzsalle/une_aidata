...
## Last updated
2026-08-11 집 PC 세션 종료 — kma_nowcast 실연계 SHADOW_TESTED(승인 1) 도달. 오늘 PR #9~#16 머지.
**개발 완료가 아니다. 승인·키·자료가 선행조건이라 진행 가능한 코드작업이 소진된 상태다** — 아래 "진행에 필요한 것" 참고.
...
- 하천 표시 밀도 — 현재 남원 실폭 400개 폴리곤이 기본. 국가·지방하천급만 남길지
