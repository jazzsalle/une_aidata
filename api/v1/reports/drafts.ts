...
import type { CurrentSituation, ReportEvidenceSelection } from '../../../server/contracts';
import { calculatePriorityAreas } from '../../../server/domain/priorityAreas';
  ...
  try{
    ...
    const report={
      ...
      sections:{
        ...
        flood_mask_pixel_metrics:selection?.satellite_event_set?seed.floodMaskMetrics:null,
