...
async function searchSimilarEvents(situation, topK = 5) {
    ...
    const warnings = [];
    try {
        records = (0, domainProviders_1.eventProvider)().listRecords();
    }
    catch (e) {
