...
class Region(NamedTuple):
    ...
    """전국하천표준데이터는 코드가 없고 주소·기관명 문자열뿐이라 이 낱말로 지역을 가른다."""
...
REGIONS: tuple[Region, ...] = (
    Region('41430', '경기도 의왕시', '경기', ('41430',), ('의왕시',), (126.968, 37.344)),
    Region('47190', '경상북도 구미시', '경북', ('47190',), ('구미시',), (128.344, 36.119)),
    Region('45190', '전북특별자치도 남원시', '전북특별자치도', ('52190',), ('남원시',), (127.390, 35.416)),
    Region('47230', '경상북도 영천시', '경북', ('47230',), ('영천시',), (128.926, 36.000)),
    Region('51810', '강원특별자치도 인제군', '강원특별자치도', ('51810',), ('인제군',), (128.249, 38.038)),
    Region('26', '부산광역시', '부산', ('26',), ('부산광역시',), (129.127, 35.253)),
)
